package com.car.rentals.newversioncarrentals.javafx;

import com.car.rentals.newversioncarrentals.NewVersionCarRentalsApplication;
...
public class JavafxApplication extends Application {
    ...
    public void init() throws Exception {
        ...
        this.context = new SpringApplicationBuilder()
                .sources(NewVersionCarRentalsApplication.class)
